...
{
    public partial class pocattdbContext : DbContext
    {
        public pocattdbContext()
        {
        }

        public pocattdbContext(DbContextOptions<pocattdbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuildVersion>(entity =>
            {
                entity.HasKey(e => e.SystemInformationId)
                    .HasName("PK__BuildVer__35E58ECA809DCAAD");
